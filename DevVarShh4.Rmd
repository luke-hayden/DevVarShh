...
ggsave(plot=plotlist[[2]],height=7, width=12,device="png", file=paste(jaw,"timevardev05.png" ,sep="") )

ggsave(plot=plotlist[[2]],height=7, width=12,device="pdf", file=paste(jaw,"timevardev05.pdf" ,sep="") )


ggsave(plot=plotlistbox[[2]],height=7, width=12,device="pdf", file=paste(jaw,"allvardev05.pdf" ,sep="") )


ggsave(plot=plotlistbox[[2]],height=7, width=12,device="png", file=paste(jaw,"allvardev05.png" ,sep="") )
```
